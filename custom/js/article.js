var Article = {
  ...
  analysisTextIframeImage: function (body, postId, isDoubleSize) {
    ...
    linkElement.setAttribute("href", "https://woolito.tumblr.com/post/" + postId + "/");

    var shortcutElement = document.createElement("img");
    shortcutElement.className = "shortcut lazy";
    if (youtubeId) {
      if (isDoubleSize) {
        shortcutElement.setAttribute("src", "https://static.tumblr.com/sirdwhf/d3fogfnxn/loading_icon.gif");
